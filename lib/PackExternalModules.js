...
module.exports = {
                ...
                return fse.pathExists(packageLockPath)
                    .then((exists) => {
                        if (exists) {
                            ...
                            try {
                                const packageLockJson = fse.readFileSync(packageLockPath);
                                /**
   ...
   */
                                ...
                                fse.writeFileSync(path.join(compositeModulePath, "package-lock.json"), JSON.stringify(packageLockJson, null, 2));
                            } catch (err) {
                    ...
                    .then(PromiseHelper.mapSeries((compileStats) => {
