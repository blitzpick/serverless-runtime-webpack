    ...
    packExternalModules(func, stats, pathDist) {
        ...
        return (new Promise((resolve, reject) => 
            ...
            .then((dependencyGraph) => {
                ...
                const compositeModulePath = path.join(os.tmpDir(), 'dependencies');
                ...
                fse.emptyDir(compositeModulePath);
                ...
                return fse.pathExists(packageLockPath)
                    ...
                    .then(stats => PromiseHelper.mapSeries(stats, (compileStats) => {
                        ...
                        .then(() => console.log(`Copy modules: ${modulePath} [${_.now() - startCopy} ms]`));
                    }));
                    // .then(fse.remove(compositeModulePath));
            });
    }
};
